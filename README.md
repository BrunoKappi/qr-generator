...
| :---: | :---: |
| ![Bkappi QR Studio - Dark Theme](https://cdn.bkappi.com/ProjectsAssets/QR-Generator/HomePageDarkTheme.png) | ![Bkappi QR Studio - Light Theme](https://cdn.bkappi.com/ProjectsAssets/QR-Generator/HomePageLightTheme.png) |

### 🎨 **Customization & Templates**
| Premium Export & Custom Options | Professional Pre-configured Templates |
| :---: | :---: |
| ![Premium QR Generation](https://cdn.bkappi.com/ProjectsAssets/QR-Generator/QrCodeExampleGenerated.png) | ![Templates Gallery](https://cdn.bkappi.com/ProjectsAssets/QR-Generator/QrCodeTemplatesExamples.png) |
...
- **Support for Standard Formats:** Automatically identifies and formats inputs for:
  - 🌐 *URL / Link*: Standard website web routing.
  - 📶 *Wi-Fi Network*: Connection parameters (SSID, Password, Security type: WPA/WEP/None).
  - ✉️ *E-mail*: Mailto links with custom template support (To, Subject, Body).
  - 📞 *Phone*: Direct-dial international protocols.
